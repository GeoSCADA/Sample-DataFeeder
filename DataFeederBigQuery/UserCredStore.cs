// Class to manage the storage and retrieval of user name and password data.
// Data is encrypted using Microsoft methods which aim to ensure that the
// credentials are only decryptable on the PC they were encrypted on.
// Consequently you cannot copy the credentials files to another PC, 
// you must re-enter and encrypt from the command line.
using System;
using System.Text;
